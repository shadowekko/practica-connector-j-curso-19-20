...
*/
    ...
    public long createUser(String username) throws SQLException {
        ...
        ps = conn.prepareStatement("INSERT INTO users(username) VALUES (?)", Statement.RETURN_GENERATED_KEYS);

        ps.setString(1,username);

        ps.executeUpdate();

        long userId = this.getAutogeneratedId(ps);
    ...
    public long createChatRoom (long userId, String chatRoomName) throws SQLException {
        ...
        ps = conn.prepareStatement("INSERT INTO chatrooms(name, createdBy) VALUES (?,?)", Statement.NO_GENERATED_KEYS);
        ...
        long chatRoomId = this.getAutogeneratedId(ps);
    ...
    public void sendMessage (long userId, long chatRoomId, String text) throws SQLException {
        ...
        ps = conn.prepareStatement("INSERT INTO messages(text, chatroom, createdBy) VALUES (?, ?, ?)");
    ...
    public List<Message> getMessages (long chatRoomId) throws SQLException {
        ...
        ps = conn.prepareStatement ("SELECT text, createdBY FROM messages WHERE chatroom = ?");
        ...
        while (result.next()){
            ...
            msgs.add(new Message(text, createdBy));
        }
    ...
    public List<ChatRoom> getChatRooms () throws SQLException {
        ...
        ps = conn.prepareStatement("SELECT id, name FROM chatrooms");
