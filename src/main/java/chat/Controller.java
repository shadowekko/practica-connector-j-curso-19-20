...
*/
    ...
    public long createUser(String username) throws SQLException {
        ...
        long userId = this.getAutogeneratedId(stmt);
    ...
    public long createChatRoom (long userId, String chatRoomName) throws SQLException {
        ...
        PreparedStatement stmt = conn.prepareStatement("INSERT INTO chatrooms(name, createdBy) VALUES (?,?)", Statement.NO_GENERATED_KEYS);
        ...
        long chatRoomId = this.getAutogeneratedId(stmt);
    ...
    public List<Message> getMessages (long chatRoomId) throws SQLException {
        ...
        return msgs;  //es un return de prueba @fernando
